...
# Assert
TARGET_OTA_ASSERT_DEVICE := RMX3191,even,rmx3191,RMX3195,rmx3195,RMX3197,rmx3197

# AVB (Android Verified Boot)
BOARD_AVB_ENABLE := true
BOARD_AVB_MAKE_VBMETA_IMAGE_ARGS += --flags 3

BOARD_AVB_KEY_PATH := vendor/realme/even/keys/avb_rsa4096.pem
BOARD_AVB_ALGORITHM := SHA256_RSA4096

BOARD_AVB_VBMETA_SYSTEM := system
BOARD_AVB_VBMETA_SYSTEM_KEY_PATH := vendor/realme/even/keys/avb_rsa2048.pem
BOARD_AVB_VBMETA_SYSTEM_ALGORITHM := SHA256_RSA2048
BOARD_AVB_VBMETA_SYSTEM_FLAGS := 3
BOARD_AVB_VBMETA_SYSTEM_ROLLBACK_INDEX := $(PLATFORM_SECURITY_PATCH_TIMESTAMP)
BOARD_AVB_VBMETA_SYSTEM_ROLLBACK_INDEX_LOCATION := 1

BOARD_AVB_VBMETA_VENDOR := vendor
BOARD_AVB_VBMETA_VENDOR_KEY_PATH := vendor/realme/even/keys/avb_rsa2048.pem
BOARD_AVB_VBMETA_VENDOR_ALGORITHM := SHA256_RSA2048
BOARD_AVB_VBMETA_VENDOR_FLAGS := 3
BOARD_AVB_VBMETA_VENDOR_ROLLBACK_INDEX := $(PLATFORM_SECURITY_PATCH_TIMESTAMP)
BOARD_AVB_VBMETA_VENDOR_ROLLBACK_INDEX_LOCATION := 2

BOARD_AVB_RECOVERY_KEY_PATH := vendor/realme/even/keys/avb_rsa2048.pem
...
TARGET_KERNEL_CLANG_PATH := $(shell if [ -d $(pwd)/prebuilts/clang/host/linux-x86/greenforce-clang ]; then echo "$(pwd)/prebuilts/clang/host/linux-x86/greenforce-clang"; elif command -v clang &>/dev/null; then dirname $(which clang); else echo "ERROR: No clang found"; fi)
...
BOARD_VENDORIMAGE_PARTITION_RESERVED_SIZE := 1392508928
